...
import Design from "../particles-effect/Design";
  ...
  return (
    <div className="w-screen h-screen text-center text-3xl items-center relative">
      ...
      <Link to="contact" smooth={true} duration={500}>
        ...
        >
          <img src="/Contact/mail.png" alt="mail" className="h-12 md:h-20" />
        </a>
        <a
          ...
          className="hover:cursor-pointer transition-transform transform hover:scale-110"
        >
          <img src="/Contact/github.png" alt="github" className="h-12 md:h-20" />
        </a>
        <a
          ...
          className="hover:cursor-pointer transition-transform transform hover:scale-110"
        >
          <img src="/Contact/twitter.png" alt="twitter" className="h-12 md:h-20" />
        </a>
        <a
          ...
          className="hover:cursor-pointer transition-transform transform hover:scale-110"
        >
          <img src="/Contact/linkedin.png" className="h-12 md:h-20" alt="linkedin" />
        </a>
      </div>
        </div>
      ...
      <div className='h-[120vh] bg-[url("/1.jpg")] bg-cover bg-center backdrop-blur-lg'>
        <About />
      </div>
